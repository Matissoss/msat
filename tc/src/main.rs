...
fn main() {
    ...
    // are arguments.
    send_request("POST 10 1 password=test 1 2 3 4 5 6\r");
    // Teacher
    send_request("POST 10 2 password=test 1 Teacher Hello\r");
    // 0800 and 0900 are: 8:00 and 9:00
    send_request("POST 10 3 password=test 1 1500 1600\r");
    // USE _ instead of ' '
    send_request("POST 10 4 password=test 1 Edukacja_dla_bezpieczenstwa\r");
    send_request("POST 10 5 password=test 1 Polish_room\r");
    send_request("POST 10 6 password=test 1 5 1 1\r");
